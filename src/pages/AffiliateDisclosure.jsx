    ...
    <Layout>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 prose prose-lg prose-blue text-gray-600">
        <p className="lead text-xl text-gray-800 mb-8">
          The short version: HiTechDevs participates in affiliate programs. If you purchase through our links, we may earn a commission. This comes at no extra cost to you.
        </p>
        ...
        <h3>Questions?</h3>
        <p>
          If you have any questions about our affiliate relationships or how we fund this site, please contact us at <a href="mailto:support@hitechdevs.online">support@hitechdevs.online</a>.
        </p>
