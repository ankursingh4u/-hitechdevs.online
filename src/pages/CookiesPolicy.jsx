      ...
      <div className="bg-white py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-brand mx-auto text-gray-600">
            ...
            <p>
              At HiTechDevs, we use cookies to:
            </p>
            ...
            <p>
              If you have any questions about our use of cookies, please contact us at privacy@hitechdevs.online or visit our <a href="/contact" className="text-brand-600 hover:text-brand-700 underline">Contact page</a>.
            </p>
          </div>
        </div>
      </div>
