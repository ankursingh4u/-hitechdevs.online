        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              ...
              <br /><br />
              For fast inquiries, you can also email us directly at <a href="mailto:support@hitechdevs.online" className="text-brand-600 hover:text-brand-700 font-medium">support@hitechdevs.online</a>.
            </p>
