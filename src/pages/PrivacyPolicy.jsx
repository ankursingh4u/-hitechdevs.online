  ...
  return (
    <Layout>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 prose prose-blue text-gray-600">
        ...
        <p>
          This Privacy Policy explains how HiTechDevs (hitechdevs.online) collects, uses, and protects your information when you visit our website. By using our site, you agree to the collection and use of information in accordance with this policy.
        </p>
